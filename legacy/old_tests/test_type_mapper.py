...
class TestTypeMapper:
    ...
    def test_pandas_mappings(self):
        ...
        assert isinstance(
            self.mapper.get_library_type("string", "pandas"), pd.api.extensions.ExtensionDtype
        )
    ...
    @pytest.mark.skipif(
        not (has_sqlalchemy and has_pandas and has_polars),
    ...
    @pytest.mark.skipif(
        not (has_pandera and has_sqlalchemy and has_pandas and has_polars),
        reason="One or more required libraries not installed",
    )
