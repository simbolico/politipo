...
from politipo.plugins.sqlalchemy import SQLAlchemyModelTypeSystem, SQLAlchemyTypeSystem
...
try:
    ...
    if _HAS_PANDERA and PydanticTypeSystem is not None:
        from .schema_tools import pandera_to_pydantic_model, pydantic_to_pandera_schema
    ...
    def pydantic_to_pandera_schema(*args, **kwargs):
        raise ImportError("Missing dependencies for schema_tools")

    def pandera_to_pydantic_model(*args, **kwargs):
        raise ImportError("Missing dependencies for schema_tools")
